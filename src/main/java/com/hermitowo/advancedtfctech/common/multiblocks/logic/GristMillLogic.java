...
import com.hermitowo.advancedtfctech.common.multiblocks.shapes.GristMillShapes;
...
public class GristMillLogic implements IMultiblockLogic<GristMillLogic.State>, IServerTickableComponent<GristMillLogic.State>, IClientTickableComponent<GristMillLogic.State>
{
    public static final BlockPos REDSTONE_POS = new BlockPos(1, 1, 0);
    private static final CapabilityPosition ENERGY_POS = new CapabilityPosition(3, 1, 1, RelativeBlockFace.LEFT);
    ...
    private static final MultiblockFace OUT_POS = new MultiblockFace(1, 0, 3, RelativeBlockFace.BACK);
    ...
    {
        return GristMillShapes.SHAPE_GETTER;
    }

    public static class State implements IMultiblockState, ATTProcessContext<GristMillRecipe>
    {
        private final AveragingEnergyStorage energy = new AveragingEnergyStorage(ENERGY_CAPACITY);
        private final MultiblockProcessor<GristMillRecipe, ATTProcessContext<GristMillRecipe>> processor;
        ...
        public State(IInitialMultiblockContext<State> ctx)
        {
            ...
            this.inventory = SlotwiseItemHandler.makeWithGroups(List.of(
                new SlotwiseItemHandler.IOConstraintGroup(SlotwiseItemHandler.IOConstraint.input(stack -> GristMillRecipe.findRecipe(getLevel.get(), stack) != null), IN_SLOT_COUNT),
            ...
            this.processor = new MultiblockProcessor<>(
                1, 0, 1, markDirty, GristMillRecipe.RECIPES::getById
            );
        ...
        public List<MultiblockProcess<GristMillRecipe, ATTProcessContext<GristMillRecipe>>> getProcessQueue()
        {
